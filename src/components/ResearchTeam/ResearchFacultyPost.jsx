...
export default function EventPost({id, first_name,middle_name, last_name, suffix, designation, fileName }) {
...
<>
          ...
          <Card className="mt-4 mb-4" bg="light" align='center' >
            <Style>
              <Card.Body>
              <Card.Img    class="rounded-circle" variant="top"   width="150" height="150"   src={`${API_URL}${research_team_content}${id}`}  />
              <br></br>
                <br></br>
              <Typography  variant="body2" component="div" sx={{  fontWeight: 'bold' }}>
              {first_name} {middle_name}. {last_name} {suffix && `, ${suffix}`}
              </Typography>
