...
const options = { month: 'long', day: 'numeric' , year: 'numeric'};
  ...
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a >Collections</a></li>
...
<div className="d-flex justify-content-between align-items-center">
  ...
  {(showAdminBoard || showModeratorBoard) && currentUser && (
    <div>
      <Link
        to={"/collection/" + currentTutorial.id}
        ...
        Edit Collection
          ...
          <Card sx={{ maxWidth: 960 }} className= 'mt-4'>
            <CardMedia
                component="img"
                height="450"
                  image={`http://localhost:5001/api/collection-content/${currentTutorial.fileName}`}
                  alt="green iguana"
                />
          </Card>
