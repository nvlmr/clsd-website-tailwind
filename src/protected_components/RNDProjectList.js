...
const EventList = () => {
  ...
  const handleExportCSV = () => {
    ...
    const dataToExport = selectedTutorials.map((tutorial) => ({
      ...
      project_leader: tutorial.project_leader,
      implementing_agency: tutorial.implementing_agency,
...
const options = { month: 'long', day: 'numeric' , year: 'numeric'};
  ...
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a > Research and Development </a></li>
        ...
        <div className="list row">
          ...
          <div className="col-md-6">
            ...
            <h4>R&D Project List </h4>
      


            <Link to="/rnd_project_add">
...
<div className="d-flex justify-content-between align-items-center">
  ...
  {(showAdminBoard || showModeratorBoard) && currentUser && (
    <div>
      <Link
        to={"/rnd_project/" + currentTutorial.id}
      ...
      >
        Edit Project
                ...
                <div className= 'mt-4'>
                  {currentTutorial.createdAt}  {new Date(currentTutorial.createdAt).toLocaleDateString("en-US",options)}
                </div>

          
                <div className= 'mt-4'  >
                   <h3>   {currentTutorial.tags} </h3>
                </div>
                ...
                <div className= 'mt-4'>
                  ...
                  {currentTutorial.project_leader}
                </div>

                <div className= 'mt-4'>
                <label>Implementing Agency: </label>
                  {currentTutorial.implementing_agency}
                </div>
