...
const handleDelete = () => {
  ...
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a >Literature</a></li>
...
<div className="d-flex justify-content-between align-items-center">
  ...
  {(showAdminBoard || showModeratorBoard) && currentUser && (
    <div>
      <Link
        to={"/literature/" + currentTutorial.id}
  ...
  */}
                ...
                <div  className= 'mt-4'>
                 ...
                 <a href={currentTutorial.link} target="_blank" rel="noreferrer noopener">{currentTutorial.title}</a>  
                </div>
                ...
                <div  className= 'mt-4'>
                 ...
                 <a href={currentTutorial.doi} target="_blank" rel="noreferrer noopener">{currentTutorial.doi}</a>  
                </div>
